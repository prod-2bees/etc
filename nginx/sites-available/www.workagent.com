server {
    listen   443 ssl spdy;
    server_name www.workagent.com;
    ssl on;
    ssl_session_timeout 5m;
    ssl_stapling on;
    ssl_certificate        /etc/ssl/workagent/combined-all.crt;
    ssl_certificate_key    /etc/ssl/workagent/workagent.com.key;
...
# for custom CSP headers use: http://cspbuilder.info
    ...
    root /home/www/www.workagent.com/html;
...
fastcgi_pass unix:/var/run/php5-fpm.sock;
    ...
    access_log /home/www/shared/log/www.workagent.com-access.log;
    error_log /home/www/shared/log/www.workagent.com-error.log;
