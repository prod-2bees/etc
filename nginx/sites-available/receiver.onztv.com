...
server {
    listen   443 ssl spdy;
    server_name receiver.onztv.com;
    ssl on;
    ssl_session_timeout 5m;
    ssl_stapling on;
    ssl_certificate        /etc/ssl/onztv/all-certs.crt;
    ssl_certificate_key    /etc/ssl/onztv/onztv.com.key;
...
# for custom CSP headers use: http://cspbuilder.info
    ...
    root /home/www/receiver.onztv.com/html;
...
fastcgi_pass unix:/var/run/php5-fpm.sock;
    ...
    access_log /home/www/shared/log/receiver.onztv.com-access.log;
    error_log /home/www/shared/log/receiver.onztv.com-error.log;
