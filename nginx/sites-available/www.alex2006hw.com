server {
    listen   443 ssl spdy;
    server_name www.alex2006hw.com;
    ssl on;
    ssl_session_timeout 5m;
    ssl_stapling on;
    ssl_certificate        /etc/ssl/alex2006hw/combined-all.crt;
    ssl_certificate_key    /etc/ssl/alex2006hw/alex2006hw.key;
...
# for custom CSP headers use: http://cspbuilder.info
    ...
    root /home/www/www.alex2006hw.com;
...
#    }
    ...
    access_log /home/www/shared/log/www.alex2006hw.com-access.log;
    error_log /home/www/shared/log/www.alex2006hw.com-error.log;
