server {
    listen   443 ssl spdy;
    server_name www.davisholding.com;
    ssl on;
    ssl_session_timeout 5m;
    ssl_stapling on;
    ssl_certificate        /etc/ssl/davisholding/davisholding.com.crt;
    ssl_certificate_key    /etc/ssl/davisholding/davisholding.com.key;
...
# for custom CSP headers use: http://cspbuilder.info
    ...
    root /home/www/www.davisholding.com;
...
fastcgi_pass unix:/var/run/php5-fpm.sock;
    ...
    access_log /home/www/shared/log/www.davisholding.com-access.log;
    error_log /home/www/shared/log/www.davisholding.com-error.log;
